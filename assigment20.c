#include<stdio.h>
//programm to make simple calculator
...
switch(operation){
    ...
    case 1:printf("enter the value of \na \nb");
    scanf("%d%d",&a,&b);
    sum=a+b;
    printf("sum is =%d",sum);
    break;
    
   case 2:printf("enter the value of \na \nb");
   scanf("%d%d",&a,&b);
   subtraction=a-b;
   printf("subtraction is =%d",subtraction);
   break;

   case 3:printf("enter the value of \na \nb");
   scanf("%d%d",&a,&b);
   multiplication=a*b;
   printf("multiplication is=%d",multiplication);
   break;
   
   case 4:printf("enter the value of \na \nb");
   scanf("%d%d",&a,&b);
   division=a/b;
